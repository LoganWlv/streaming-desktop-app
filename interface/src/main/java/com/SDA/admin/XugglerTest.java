...
public class XugglerTest {
  ...
  private static String url = "rtmp://192.168.1.10/screen/";
  ...
  public static void main(String[] args) {
    ...
    InputStream is = XugglerTest.class.getResourceAsStream("/libx264-normal.ffpreset");
    try {
      props.load(is);
    } catch (IOException e) {
    ...
    try {
      ...
      while (i < framesToEncode) {
        ...
        BufferedImage currentScreenshot = new BufferedImage(image.getWidth(), image.getHeight(),
        ...
        if (packet.isComplete()) {
          ...
          System.out.println("[ENCODER] writing packet of size " + packet.getSize() + " for elapsed time "
